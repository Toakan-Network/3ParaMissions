//3 Para
Para_acceptableCorners = 4;
Para_DrawConnectArea = true;
...
force ace_casings_maxCasings = 40;
...
// ACE Cook off
force ace_cookoff_ammoCookoffDuration = 0.238005;
...
force ace_explosives_customTimerMax = 60;
...
// ACE G-Forces
force ace_gforces_coef = 0.249084;
...
force ace_hearing_earplugsVolume = 0.708717;
...
force ace_medical_deathChance = 0.500938;
...
force ace_medical_treatment_treatmentTimeSplint = 10;
...
force ace_nightvision_effectScaling = 0.35;
force ace_nightvision_fogScaling = 0.35;
force ace_nightvision_noiseScaling = 0.35;
...
// ACE Trenches
force ace_trenches_bigEnvelopeDigDuration = 5;
...
force acre_sys_core_terrainLoss = 0.0476011;
force acre_sys_core_ts3ChannelName = "Training";
force acre_sys_core_ts3ChannelPassword = "training123";
...
force camshake_fn = true;
force camshake_sdr = 200;
force gBreathe_sound_fn = true;
force gear_fn = true;
force gear_snd_alarm_fn = true;
force gear_snd_rum_fn = true;
force gearP_sdr = 600;
force Gforces_fn = false;
force gforces_sdr = 1;
force Gforces_Vol_fn = true;
force gforces_Vol_sdr = 30;
force ground_fn = true;
force groundP_sdr = 50;
force landingVEF_fn = true;
force sonicboom_fn = true;
force sonicboom_tmp_fn = true;
force taxiing_fn = true;
force Taxiing_sound_fn = true;
force Taxing_sound_fn = true;
force TDSound_fn = true;
force turbulent_sdr = 10;
force turbulent_snd_alarm_fn = true;
force turbulent_snd_rum_fn = true;
force turbulentH_fn = true;
force turbulentH_snd_alarm_fn = true;
force turbulentP_fn = true;
force turbulentS_fn = true;
force turbulentS_snd_alarm_fn = true;
force turbulentT_sdr = 50;
force vapor_fn = true;
...
force fza_ah64_vanillaTargetingEnable = false;

// Alternative Running (Client Settings)
AR_EnableDisableAltRunMGBOLT = true;
AR_EnableDisableDoubleShiftPress = true;
...
force cba_disposable_dropUsedLauncher = 0;
...
diwako_dui_radar_namelist_vertical_spacing = 9;
...
force PDT_ENVG_Effect = "mwEffect";
...
force grad_trenches_functions_bigEnvelopeDigTime = 15;
...
force grad_trenches_functions_giantEnvelopeDigTime = 20;
force grad_trenches_functions_giantEnvelopeRemovalTime = -1;
force grad_trenches_functions_hitDecayMultiplier = 0.508916;
...
force greenmag_main_CBAS_maxMags = 4;
force greenmag_main_CBAS_simpleGM = false;

// Illuminate The Night
force gjb_itn_setting_drawDist = 1000;
force gjb_itn_setting_interfaceOverlay = false;
force gjb_itn_setting_simpleCtrl = false;
...
force IMS_DamageMultiplierParamPlayer = "0.1";
force IMS_ExecutionChanceParametr = "100";
...
force kat_airway_Accuvac_time = 2.2596;
...
force kat_breathing_SpO2_dieValue = 64.9393;
...
force kat_breathing_SpO2_unconscious = 79.8557;
...
force kat_chemical_gasmask_durability = 3600;
...
force kat_pharma_chromatic_aberration_checkbox_fentanyl = false;
force kat_pharma_chromatic_aberration_checkbox_ketamine = false;
force kat_pharma_chromatic_aberration_checkbox_pervitin = false;
...
force kat_surgery_compoundChance = 9.79717;
...
// LAxemann's Suppress
force L_Suppress_buildup = 0.762145;
force L_Suppress_enabled = true;
force L_Suppress_flyByEffects = true;
force L_Suppress_flyByIntensity = 0.880644;
force L_Suppress_halting = true;
force L_Suppress_intensity = 0.823832;
force L_Suppress_playerSwabEnabled = true;
force L_Suppress_recovery = 0.727422;

// Metis Presentation
force mts_presentation_cba_settings_actions = "ace_interaction";
force mts_presentation_cba_settings_controls = "";
force mts_presentation_cba_settings_screens = "";
force mts_presentation_displayCurrentSlide = true;
force mts_presentation_dispSlideSize = "small";
force mts_presentation_previewNextSlide = true;
force mts_presentation_sortAlphabetically = true;

// Military Tandem Tethered Bundle
force mttb_main_MaxCargoMass = 500;
...
// Training Magazines
training_mag_dynamic_unconsciousTime = true;
...
tsp_cba_sound_inv = true;
tsp_cba_sound_map = true;
tsp_cba_throw = true;
tsp_cba_throw_uncon = 0;
tsp_cba_throw_velocity = "[0,5,5]";
...
WP_DustStorm = true;
WP_FallingStar = true;
WP_FallingStarRemove = true;
WP_lowFog = true;
WP_Meteor = true;
WP_MeteorSmall = true;
WP_MeteorStorm = true;
WP_MeteorStormRemove = true;
WP_Monsoon = true;
WP_Mountainfog = true;
WP_PlayerFog = true;
WP_PlayerFogRemove = true;
WP_RockSlide = true;
WP_SnowFall = true;
WP_SnowFallRemove = true;
WP_SnowStorm = true;
WP_ThunderStorm = true;
WP_Tornado = true;
WP_TornadoRemove = true;
WP_Volcano = true;
WP_VolcanoRemove = true;
WP_WindGust = true;
...
zen_faction_filter_0_BLU_F = true;
...
zen_faction_filter_0_RKSLA3_Airfield_Support = true;
zen_faction_filter_0_ua_cartel = true;
zen_faction_filter_0_ua_islamic_state = true;
zen_faction_filter_0_ua_islamic_state_asia = true;
...
force zen_faction_filter_0_WBK_AI = true;
zen_faction_filter_0_WBK_AI_Melee = true;
zen_faction_filter_1_afuk = true;
zen_faction_filter_1_BAF = true;
...
zen_faction_filter_1_lb_Eden_Category = true;
...
zen_faction_filter_1_RKSLA3_Airfield_Support = true;
...
zen_faction_filter_2_RKSLA3_Airfield_Support = true;
...
zen_faction_filter_3_RKSLA3_Airfield_Support = true;
