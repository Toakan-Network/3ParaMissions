...
addMissionEventHandler ["PlayerConnected", {
	...
	[2, format ["%1 Player connected.", _name]] call tcz_fnc_log;   
	...
	if (((_uid in Zeus_IDs) || (_uid in ServerAdmins)) && isNull (getAssignedCuratorLogic _player)) then {
		...
		[3, format ["%1 is a registered Zeus, assigning module.", _playerName], "mission_eh.sqf"] call tcz_fnc_log;   
...
[3, format ["Script complete - %1", _filename], _filename] call tcz_fnc_log;  