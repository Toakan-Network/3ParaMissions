...
if (!isnil "_map") then {
	...
	// Setup box
	_spawnVhc = createVehicle ["plp_ct_MilBoxLongOlive", _posA,[],0,"NONE"];
	_spawnVhc setDir 0;
	...
	_spawnVhc addItemCargoGlobal ["UK3CB_BAF_Javelin_CLU", 2];
	_spawnVhc addItemCargoGlobal ["UK3CB_BAF_Javelin_Slung_Tube", 4];
