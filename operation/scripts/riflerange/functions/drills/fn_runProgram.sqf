...
if (_primary) then {
	if !(isNil format ["%1_loudspeaker", _rangeID] || missionNamespace getVariable [format ["%1_SPEAKER_MUTED",_rangeID],false]) then {
		["sound\riflerange\BUZZER_ARENA_SHORT.ogg",missionNamespace getVariable format ["%1_loudspeaker",_rangeID],false,missionNamespace getVariable format ["%1_loudspeaker",_rangeID] modelToWorld [0,0.00390625,3.96981],3] call RR_fnc_PlayMissionSound3D;
	};
...
if (_primary) then {
	...
	if !(isNil format ["%1_loudspeaker", _rangeID] || missionNamespace getVariable [format ["%1_SPEAKER_MUTED",_rangeID],false]) then {
		["sound\riflerange\BUZZER_ARENA_LONG.ogg",missionNamespace getVariable format ["%1_loudspeaker",_rangeID],false,missionNamespace getVariable format ["%1_loudspeaker",_rangeID] modelToWorld [0,0.00390625,3.96981],3] call RR_fnc_PlayMissionSound3D;
	};
