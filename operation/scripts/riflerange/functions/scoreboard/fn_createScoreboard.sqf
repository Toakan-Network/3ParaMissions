...

{
...

	{
		...
		_laneIndex = _forEachIndex;
		{
			_scoreColumnIndex = _forEachIndex;
			{
				...
				_background setObjectTextureGlobal [0,"textures\riflerange\blackbox.paa"];
	...
	_x setObjectTextureGlobal [0,"textures\riflerange\board5a.paa"];
...
if (_scoreboardLaneID < 1) then {
	...
	_scoreboardObj setObjectTextureGlobal [0,"textures\riflerange\board5b.paa"];
