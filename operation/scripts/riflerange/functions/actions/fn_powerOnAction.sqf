...
if (typeOf (missionNamespace getVariable format ["%1_CONTROL_OBJ",_rangeID]) == "Land_Laptop_unfolded_F") then {
	missionNamespace getVariable format ["%1_CONTROL_OBJ",_rangeID] setObjectTextureGlobal [0,"textures\riflerange\laptop5a.paa"];
};
...
{
	_x setObjectTextureGlobal [0,"textures\riflerange\x.paa"];
