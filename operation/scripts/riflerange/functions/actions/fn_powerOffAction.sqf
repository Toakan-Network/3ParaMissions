...
if (typeOf (missionNameSpace getVariable format ["%1_CONTROL_OBJ",_rangeID]) == "Land_Laptop_unfolded_F") then {
	missionNameSpace getVariable format ["%1_CONTROL_OBJ",_rangeID] setObjectTextureGlobal [0,"textures\riflerange\blk.paa"];
};
...
{
	_x setObjectTextureGlobal [0,"textures\riflerange\blank.paa"];
